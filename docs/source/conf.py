...
# -*- coding: utf-8 -*-
#
# starspot documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'starspot.tex', 'starspot Documentation',
     'Ruth Angus', 'manual'),
]
...
man_pages = [
    (master_doc, 'starspot', 'starspot Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'starspot', 'starspot Documentation',
     author, 'starspot', 'One line description of project.',
     'Miscellaneous'),
]
